...
- [ ] `Programs` (625 LOC) decomposed
- [ ] `MainScreen` (490 LOC) decomposed
- [ ] Extracted components are barrel-exported molecules/organisms
- [ ] No direct `PALETTE` imports left in either
