...
export const PALETTELIGHT = {
  ...
  BG_PRIMARY_COLOR: '#198754',
  BG_SECONDARY_COLOR: '#E6F4EA',
  BG_TERTIARY_COLOR: '#c6c6c6',
  LINE: '#E5E7EB',
  BUTTON_MAIN_COLOR: '#198754',
...
/**
 * @deprecated Use `useTheme().colors` instead. This binding captures the light
 * palette at module load and never updates on theme toggle.
 */
// eslint-disable-next-line no-var
export var PALETTE = PALETTELIGHT;

/** Readonly palette type used across the token layer — covers both light and dark. */
export type ColorTokens = typeof PALETTEDARK | typeof PALETTELIGHT;
